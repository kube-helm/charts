...
```
kubectl create secret docker-registry registry-vcreator-indonesia --docker-username=vcreator.indonesia --docker-password=kDQ831ZnsmLU --docker-server=hub.viewboost.vn
```
...
## Install chart
```
helm upgrade --install affiliate-product/vinfast
```